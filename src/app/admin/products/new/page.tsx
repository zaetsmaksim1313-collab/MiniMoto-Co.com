...
export default function NewProductPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert("Failed to save: Payload might be too large. Try picking fewer photos or compressing them. " + error.message);
            setIsSaving(false);
        }
    };
        ...
        <div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <div className="admin-card">
                    ...
                    >
                        <input id="new-file-upload" type="file" multiple accept="image/*" onChange={handleImageUpload} style={{ display: 'none' }} />
